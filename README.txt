...
This is the readme for Labirinthan, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. Labirinthan) > Ok.
...
- To run the project find Labirinthan.java (which will be in under src/main/java/labirinthan) and right click > Run 'Labirinthan'
